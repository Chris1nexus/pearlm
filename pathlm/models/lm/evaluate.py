...
from pathlm.models.lm.generation_constraints import PrefixConstrainedLogitsProcessorWordLevel,PLMLogitsProcessorWordLevel,ConstrainedLogitsProcessorWordLevel 
...
class Evaluator:
    ...
    def evaluate(self, model):
        ...
        pickle.dump(topks, open(f"./results/{self.dataset_name}/{self.custom_model_name}/pred_paths.pkl", "wb"))
        metrics = {"ndcg": [], "mmr": [], }
...
if __name__ == "__main__":
    ...
    parser.add_argument("--infer_batch_size", type=int, default=512, help="Inference batch size")
    ...
    if args.loading_checkpoint:
        model_folder = f"clm-{args.task}-{args.dataset}-{args.model}-{args.sample_size}"
