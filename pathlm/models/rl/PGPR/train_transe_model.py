...
from pathlm.models.rl.PGPR.data_utils import DataLoader, Dataset
from pathlm.models.rl.PGPR.pgpr_utils import *
from pathlm.models.rl.PGPR.transe_model import KnowledgeEmbedding
...
def main():
    ...
    dataset = Dataset(args) #load_dataset(args.dataset)
    train(args, dataset)
